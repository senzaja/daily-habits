...
<head>
  ...
  <link rel="icon" type="image/png" href="public/as/assets/img/favicon.png">
  <title>
  ...
  <script defer data-site="YOUR_DOMAIN_HERE" src="{{ asset('as/assets/js/nepcha-analytics.js') }}"></script>
</head>
